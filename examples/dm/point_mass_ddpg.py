...
def experiment(variant):
    eval_env = DMPointMassEnv(max_steps=variant['algorithm_kwargs']['max_path_length']) 
    expl_env = DMPointMassEnv(max_steps=variant['algorithm_kwargs']['max_path_length']) 
...
if __name__ == "__main__":
    ...
    setup_logger('dm-pm-ddpg-10', variant=variant)
    experiment(variant)
